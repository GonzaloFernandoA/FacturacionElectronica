...
using ZooLogicSA.FacturacionElectronicaV2.Exportacion.Core;
using ZooLogicSA.FacturacionElectronicaV2.Exportacion.Core.DatosSegunTabla;

namespace ZooLogicSA.FacturacionElectronicaV2.ExportacionV1.Equivalencias
{
    public class FexCabecera
    {
        private long id;
        ...
        public string Serializar()
        {
            ...
            foreach (IFexItem item in this.items)
            {
